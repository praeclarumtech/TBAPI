...
export const addYear = async (req, res) => {
  try {
    ...
    logger.info(`New year is ${Message.ADDED_SUCCESSFULLY}`);
    return HandleResponse(
      res,
      true,
      StatusCodes.CREATED,
      `New year is ${Message.ADDED_SUCCESSFULLY}`
    );
  } catch (error) {
...
export const getYears = async (req, res) => {
  try {
    ...
    logger.info(`All years are ${Message.FETCH_SUCCESSFULLY}`);
    return HandleResponse(
      res,
      true,
      StatusCodes.OK,
...
export const getYearById = async (req, res) => {
  try {
    ...
    if (!yearDetail) {
      logger.info(`Year is ${Message.NOT_FOUND}`);
      return HandleResponse(
        res,
        false,
