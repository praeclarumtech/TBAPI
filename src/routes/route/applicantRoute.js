...
router.post(
  '/addApplicant',
  authorization,
  validator.body(applicantValidation),
...
router.post(
  '/applicant-add-qr-code',
  uploadAttachments,
  validator.body(applicantValidation),
  addApplicant
);
router.put(
  '/applicant-edit-qr-code/:id',
  uploadAttachments,
...
router.get(
  '/viewAllApplicant',
  authorization,
  verifyRoles([Enum.ADMIN, Enum.VENDOR, Enum.CLIENT]),
  viewAllApplicant
);

router.post(
  '/userFilter',
  validator.body(saveUserFilterValidation),
  saveUserFilter
);
router.get(
  '/userFilter/:userId',
  validator.params(getUserFilterValidation),
  getUserFilter
);
...
router.put(
  ...
  authorization,
  verifyRoles(Enum.ADMIN),
  validator.body(updateManyApplicantsValidation),
  updateManyApplicant
);
router.get(
  '/viewImportedApplicantById/:id',
  authorization,
  viewImportedApplicantById
);
router.put(
  '/updateImportedApplicant/:id',
  authorization,
  verifyRoles(Enum.ADMIN),
  validator.body(updateApplicantValidation),
  updateImportedApplicant
...
router.delete(
  '/hardDeleteImportedApplicant/:id',
  authorization,
  verifyRoles(Enum.ADMIN),
  hardDeleteImportedApplicant
);
...
router.put(
  '/update/importApplicantstatus/:id',
  authorization,
  verifyRoles(Enum.ADMIN),
  validator.body(updateApplicantValidation),
  updateStatusImportApplicant
