...
import { sendEmail, getAllEmails, deleteManyEmails, viewEmailById, exportEmails } from '../../controller/applicantEmailController.js';
...
router.get('/exportEmails', authorization, exportEmails);
