...
router.get('/viewSkills',cacheMiddleware('skill'), getSkills);
// for dashboard
router.get('/dashboard/viewSkills',cacheMiddleware('skill-dashboard'), getSkills);
router.get('/viewById/:skillId',cacheMiddleware('skill-id'), authorization, verifyRoles([Enum.ADMIN, Enum.HR]), getSkillsById);
